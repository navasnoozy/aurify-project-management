...
export const SuggestionItem = ({ suggestion, cardId, onUpdate, onDelete, onPromote }: SuggestionItemProps) => {
  ...
  return (
    <motion.div layout initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} transition={{ duration: 0.2 }}>
      <Box bg="white" borderWidth="1px" borderColor="gray.100" borderRadius="lg" boxShadow="sm" _hover={{ boxShadow: "md", borderColor: "gray.200" }} transition="all 0.2s" overflow="hidden">
        ...
        {/* Comment Thread - Visually connected as child */}
        <CommentThread suggestionId={suggestion.id} cardId={cardId} comments={suggestion.comments || []} />
      </Box>
